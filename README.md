...
The dust app already has this as a default feature (I didn't know about it when I made this), see [here](https://github.com/damiant/dust/issues/204).

# Kiezburn Calendar Parser

Convert raw text from the PDF generated by the [dust](https://dust.events/dust) app, into an `.ics` file you can import into your calendar app.
